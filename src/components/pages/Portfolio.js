  ...
  return (
    <div>
      ...
      <div classname="testTwo">
        <a classname="test" href="https://github.com/Dgardi/beer_buddy">
        <img src={proj1} alt="Project 1" className="project"/>
        </a>
      </div>

      <div classname="testTwo">
        <a classname="test" href="https://github.com/Dgardi/LEND_Inventory_Management">
        <img src={proj2} alt="Project 2" className="project"/>
        </a>
      </div>

      <div classname="testTwo">
        <a classname="test" href="https://github.com/Dgardi/hw19-text-editor.git">
        <img src={proj3} alt="Project 3" className="project"/>
        </a>
      </div>

      <div classname="testTwo">
        <a classname="test" href="https://github.com/Dgardi/hw5-workday-scheduler.git">
        <img src={proj4} alt="Project 4" className="project"/>
        </a>
      </div>

      <div classname="testTwo">
        <a classname="test" href="https://github.com/Dgardi/hw3-js-password-generator.git">
